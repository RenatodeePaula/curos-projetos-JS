...
// Selicione as cartasd e atribua um número da matriz a cada carta
...
function disableCards() {
    ...
    document.querySelectorAll("card:not(.flip").length
...
function showCongratulations() {
    ...
    congratulationsContainer.appendChild(congratulations)
    congratulationsContainer.classList.add('congratulations')
    congratulations.textContent = `Parabéns, você completou o jogo com ${attempts} tentativas!`
}
